              ...
              {!checked ? (
                ...
                <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
                  ...
                  {success ? (
                    ...
                    <button onClick={handleClaim} disabled={pending} className="w-full rounded-xl bg-gradient-to-r from-violet-600 to-blue-500 py-4 font-bold text-white shadow-[0_10px_30px_-8px_rgba(124,58,237,0.55)] transition-all hover:brightness-110 active:scale-[0.99] disabled:opacity-60">
                      {pending ? "Confirm in your wallet…" : `Claim ${CLAIMHUB_AIRDROP.amountLabel}`}
                    </button>
                  )}
                </motion.div>
              )}
