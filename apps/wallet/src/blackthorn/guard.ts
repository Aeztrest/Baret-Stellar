 ...
 * In production builds, override via VITE_BLACKTHORN_BASE_URL.
 */
const BASE_URL = (import.meta.env.VITE_BLACKTHORN_BASE_URL as string | undefined) ?? "/api";
 ...
 */
const API_KEY = (import.meta.env.VITE_BLACKTHORN_API_KEY as string | undefined) ?? "dev-key-change-me";
